...
* TODO: Replace '{{cookiecutter.app.org}}' with your github org
* TODO: Replace '{{cookiecutter.app.name}}' with your app name
* TODO: Rename the cmd/{{cookiecutter.app.name}} directory to your app name
